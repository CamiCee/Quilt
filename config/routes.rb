Rails.application.routes.draw do
    ...
    get '/clusters' => 'public#clusters'
    get '/committee' => 'public#gov'
    get '/dashboard/newsfeed' => 'users#index'
    get '/dashboard/bls' => 'books#index'
    get '/dashboard/calendar' => 'calendar#index'
    get '/dashboard/pass' => 'docs#index'
    get '/dashboard/sep' => 'sep#index'
